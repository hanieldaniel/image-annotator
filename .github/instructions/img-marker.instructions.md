...
When asked to integrate this library, follow this checklist:

1. **Identify the framework** (React, Vue, Svelte, Angular, vanilla, etc.) and adapt lifecycle management accordingly.
